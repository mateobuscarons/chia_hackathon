...
1000 designs in 39 to 44 designs, 23 to 25 times fewer simulations. % CLAUDE.md 4.1, 4.2
...
designs in 39 to 44 designs, both under the constraints and without them. % CLAUDE.md 4.1, 4.2
...
Applied, the gates gave the same final IPC for 22 to 30\% less model spend. % CLAUDE.md 4.3
...
budget of 4096 tokens. % CLAUDE.md 3

\begin{figure}[!t]
\centering
\resizebox{0.95\columnwidth}{!}{\input{fig-loop}}
...
being rebuilt from its seed and the result table. % CLAUDE.md 3
...
\midrule
% CLAUDE.md 4.1, 4.2, 4.4; council_loop/demo.py section 3
...
its sixteen runs end above that quality; the remaining one ends at 1.497 against 1.5001. % CLAUDE.md 4.1, 4.2
...
with 36\%, the single-knob fills took 24\%, and the model 40\%. % CLAUDE.md 4.4
...
paid and that one setting stalled half the seeds. % CLAUDE.md 3, 4.2, 4.11
...
of a cent and returns within a second. % CLAUDE.md 3, 4.3
...
instead, it had rated the evidence unneeded, a negative result we report. % CLAUDE.md 4.3, 4.11
...
discipline and should not be used to skip calls. % results/audit/grounding.jsonl; CLAUDE.md 4.10
\textbf{The decider cannot judge ``one clear fix''} (10 of 11 CIRCT bugs were rated unclear),
which is why the gate asks the narrower question. % CLAUDE.md 4.11
...
council needs 44 and 46 designs. % CLAUDE.md 4.1, 4.2
